    ...
    <div class="d-flex h-100">
        ...
        <div class="bg-wite m-4 mx-auto" id="content">
            <div class="container-fluid">
                <form action="worker.php" name="login-form" onsubmit="return validation()" method="POST">
                    <div class="row">
                    ...
                    <div class="row d-flex justify-content-center mt-3 mx-1">
                        ...
                        <a href="dashboard.php" class="btn custom-btn col-md-2 mx-2 h-100 my-2">انصراف</a>
